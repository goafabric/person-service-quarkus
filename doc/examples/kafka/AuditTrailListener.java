...
public class AuditTrailListener {
    ...
    private void insertAudit(final DbOperation operation, String referenceId, final Object oldObject, final Object newObject) {
        try {
            ...
            CDI.current().select(AuditTrailEventDispatcher.class).get().dispatchEvent(auditEvent, oldObject != null ? oldObject : newObject);
    ...
    static class AuditJpaInserter  {
        ...
        private String getTableName(Object object) {
            final String schema = ConfigProvider.getConfig().getValue("multi-tenancy.schema-prefix", String.class) + UserContext.getTenantId() + ".";
