...
dependencies {
	...
	implementation(enforcedPlatform("io.quarkus:quarkus-bom:3.25.3"))
}
dependencies {
	//web
	...
	annotationProcessor("org.hibernate.orm:hibernate-jpamodelgen:7.1.0.Final")
