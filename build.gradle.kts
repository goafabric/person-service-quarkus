...
dependencies {
	...
	implementation(enforcedPlatform("io.quarkus:quarkus-bom:3.31.1"))
}
dependencies {
	//web
	...
	annotationProcessor("org.hibernate.orm:hibernate-jpamodelgen:7.2.2.Final")
