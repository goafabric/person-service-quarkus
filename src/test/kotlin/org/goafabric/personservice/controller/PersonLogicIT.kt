...
@QuarkusTest
class PersonLogicIT(@Inject val personLogic: PersonLogic, @Inject private val personRepository: PersonRepository) {

    @Test
    fun findById() {
        val persons: MutableList<Person> = personLogic!!.search(PersonSearch(null, null), 1, 3)
    ...
    @Test
    fun findByFirstName() {
        val persons: MutableList<Person> = personLogic!!.search(PersonSearch("Monty", null), 1, 3)
    ...
    @Test
    fun findByLastName() {
        val persons: MutableList<Person> = personLogic!!.search(PersonSearch(null, "Simpson"), 1, 3)
